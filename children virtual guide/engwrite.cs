...
{
    public partial class engwrite : Form
    {
        double rW = 0;
        double rH = 0;
        ...
        {
            InitializeComponent();
            this.Resize += engwrite_Resize;
        }
        private void engwrite_Resize(object sender, EventArgs e)
        {
        ...
        {
            string c = listBox6.SelectedItem.ToString();
            axShockwaveFlash1.Movie = Application.StartupPath + @c;
        }

        private void engwrite_Load(object sender, EventArgs e)
        {
            rW = this.Width;
            rH = this.Height;

...
{
    public partial class color_xm : Form
    {
        double rW = 0;
        double rH = 0;
        ...
        {
            InitializeComponent();
            this.Resize += color_xm_Resize;
        }
         private void color_xm_Resize(object sender, EventArgs e)
        {
            rResize(this, true); //Call the routine
        }
        private void color_xm_Load(object sender, EventArgs e)
        {
            lb1();
            lb2();
            lb4();

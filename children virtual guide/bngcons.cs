...
{
    public partial class bngcons : Form
    {
        double rW = 0;
        double rH = 0;
        ...
        {
            InitializeComponent();
            this.Resize += bngcons_Resize;
        }
        private void bngcons_Resize(object sender, EventArgs e)
        {
        ...
        private void bngcons_Load(object sender, EventArgs e)
        {
            rW = this.Width;
            rH = this.Height;

...
{
    public partial class bngall : Form
    {
        double rW = 0;
        double rH = 0;
        ...
        {
            InitializeComponent();
            this.Resize += bngall_Resize;
        }
        private void bngall_Resize(object sender, EventArgs e)
        {
        ...
        private void bngall_Load(object sender, EventArgs e)
        {
            rW = this.Width;
            rH = this.Height;

...
namespace children_virtual_guide
{
    public partial class english : Form
    {
        ...
        {
            InitializeComponent();
            this.Resize += english_Resize;
        }

        private void english_Resize(object sender, EventArgs e)
        {
        ...
        {
            Application.Run(new eng_vowel());
        }
        private void LaunchAdminApplication9()
        {
            Application.Run(new eng_all());
        }
        private void LaunchAdminApplication10()
        {
            Application.Run(new eng_cons());
        }

...
{
    public partial class eng_quiz : Form
    {
        double rW = 0;
        double rH = 0;
        ...
        {
            InitializeComponent();
            this.Resize += eng_quiz_Resize;
        }
        private void eng_quiz_Resize(object sender, EventArgs e)
        {
            rResize(this, true); //Call the routine
        }
        private void eng_quiz_Load(object sender, EventArgs e)
        {
            lb1();
            lb2();
            ...
            button6.Visible = false; rW = this.Width;
            rW = this.Width;
            rH = this.Height;
            fW = this.Width;
            fH = this.Height;

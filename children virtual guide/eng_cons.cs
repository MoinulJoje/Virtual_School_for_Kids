...
{
    public partial class eng_cons : Form
    {
        double rW = 0;
        double rH = 0;
        ...
        {
            InitializeComponent();
            this.Resize += eng_cons_Resize;
        }
        private void eng_cons_Resize(object sender, EventArgs e)
        {
        ...
        private void eng_cons_Load_1(object sender, EventArgs e)
        {
            rW = this.Width;
            rH = this.Height;

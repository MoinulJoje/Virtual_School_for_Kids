...
{
    public partial class eng_vowel : Form
    {
        double rW = 0;
        double rH = 0;
        ...
        {
            InitializeComponent();
            this.Resize += eng_vowel_Resize;
        }
        private void eng_vowel_Resize(object sender, EventArgs e)
        {
        ...
        private void eng_vowel_Load(object sender, EventArgs e)
        {
            rW = this.Width;
            rH = this.Height;

...
{
    public partial class math_shape : Form
    {
        double rW = 0;
        double rH = 0;
        ...
        {
            InitializeComponent();
            this.Resize += math_shape_Resize;
        }
        private void math_shape_Resize(object sender, EventArgs e)
        {
        ...
        private void math_shape_Load(object sender, EventArgs e)
        {

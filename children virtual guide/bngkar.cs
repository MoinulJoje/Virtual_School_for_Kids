...
{
    public partial class bngkar : Form
    {
        double rW = 0;
        double rH = 0;
        ...
        {
            InitializeComponent();
            this.Resize += bngkar_Resize;
        }
        private void bngkar_Resize(object sender, EventArgs e)
        {
        ...
        private void bngkar_Load(object sender, EventArgs e)
        {
            rW = this.Width;
            rH = this.Height;

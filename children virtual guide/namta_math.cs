...
{
    public partial class namta_math : Form
    {
        double rW = 0;
        double rH = 0;
        ...
        {
            InitializeComponent();
            this.Resize += namta_math_Resize;
        }
        private void namta_math_Resize(object sender, EventArgs e)
        {
        ...
        private void namta_math_Load(object sender, EventArgs e)
        {
            listBox1.SelectedIndex = 0;

...
{
    public partial class welcomeForm2 : Form
    {
        double rW = 0;
        double rH = 0;
        ...
        {
            InitializeComponent();
            this.Resize += welcomeForm2_Resize;
        }
        private void welcomeForm2_Resize(object sender, EventArgs e)
        {
        ...
        private void dictionaryToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            this.Close();
            appThread = new Thread(LaunchAdminApplication5);
            appThread.SetApartmentState(ApartmentState.STA);
        ...
        private void welcomeForm2_Load(object sender, EventArgs e)
        {
            rW = this.Width;
            rH = this.Height;

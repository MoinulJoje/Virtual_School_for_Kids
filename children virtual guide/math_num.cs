...
{
    public partial class math_num : Form
    {
        double rW = 0;
        double rH = 0;
        ...
        {
            InitializeComponent();
            this.Resize += math_num_Resize;
        }
        private void math_num_Resize(object sender, EventArgs e)
        {
            rResize(this, true); //Call the routine
        }
        private void math_num_Load(object sender, EventArgs e)
        {
        ...
        {
            string f = listBox6.SelectedItem.ToString();
            System.Media.SoundPlayer player = new System.Media.SoundPlayer(@f);
            player.Play();
